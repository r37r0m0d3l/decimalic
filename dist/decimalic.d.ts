 ...
 * @returns {number}
 */
export function diff(alpha: Numeric, beta: Numeric): number;
 ...
 * @returns {number}
 */
export function divide(alpha: Numeric, beta: Numeric): number;
 ...
 * @returns {number}
 */
export function multiply(alpha: Numeric, beta: Numeric): number;
 ...
 * @returns {number}
 */
export function sum(alpha: Numeric, beta: Numeric): number;
